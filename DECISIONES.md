...
| D-017 | Cuatro desajustes entre `brief.md` y `contenido.md` del lead magnet, por resolver antes de construir. 1) Elemento 8: el brief dice tres tarjetas, el contenido dice cuatro. 2) Orden: el brief pone el antes/después (9) antes del comparador de tres estados (10); en el contenido van al revés. 3) Elemento 14: el brief llama «fuentes» a la primera capa, el contenido la llama «arquitectura». 4) El brief cuenta dos imágenes y el contenido enlaza tres. Manda el contenido salvo que Alfredo diga lo contrario, porque su texto es final por la primera regla del brief. | 2026-09-18 | Alfredo |
